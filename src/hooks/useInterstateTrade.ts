...
export interface InterstateTradeResult {
...
const useInterstateTrade = () => {
    const { states: states } = useStates()
    const [results, setResults] = useState<InterstateTradeResult[]>()
...
export default useInterstateTrade
